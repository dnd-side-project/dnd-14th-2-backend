...
public class GoogleOauthService implements OauthService {
    ...
    private final IdTokenVerifier googleIdTokenVerifier;
    ...
    public User getUserInfo(String authorizationCode) {
        ...
        OauthUserInfo oauthUserInfo = googleIdTokenVerifier.verifyAndGetUserInfo(Provider.GOOGLE, oauthToken.idToken());
