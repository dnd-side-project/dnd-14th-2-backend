    ...
    class RequestVerdict {
        ...
        void requestVerdict_docs() throws Exception {
            ...
            mockMvc.perform(
                ...
                .andDo(document("소비 심판 요청",
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    resource(ResourceSnippetParameters.builder()
                        .tag("Verdict")
                        .summary("소비 심판 요청")
                        .description("소비 내역에 대한 심판을 친구들에게 요청합니다.")
            ...
            mockMvc.perform(
                ...
                .andDo(document("소비 심판 판결",
                    ...
                    resource(ResourceSnippetParameters.builder()
                        .tag("Verdict")
                        .summary("소비 심판 판결")
                        .description("배정된 소비 심판에 대해 판결합니다.")
                        .pathParameters(
                            parameterWithName("id").description("판결할 심판 ID")
                        )
    ...
    class GetMyVerdicts {
        ...
        void getMyVerdicts_docs() throws Exception {
            ...
            MyVerdicts myVerdicts = new MyVerdicts(List.of(
                ...
                new MyVerdict(2L, new LedgerEntryInfo(2L, 15000L, LedgerCategory.FOOD, "점심"), null)
            ));
            ...
            mockMvc.perform(
                ...
                .andExpect(status().isOk())
                .andDo(document("내 소비 심판 목록 조회",
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    resource(ResourceSnippetParameters.builder()
                        .tag("Verdict")
                        .summary("내 소비 심판 목록 조회")
                        .description("내가 요청한 소비 심판 목록을 조회합니다.")
    ...
    class GetJurorVerdicts {
        ...
        void getJurorVerdicts_docs() throws Exception {
            ...
            mockMvc.perform(
                ...
                .andExpect(status().isOk())
                .andDo(document("내가 판결해야 할 소비 심판 목록 조회",
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    resource(ResourceSnippetParameters.builder()
                        .tag("Verdict")
                        .summary("내가 판결해야 할 소비 심판 목록 조회")
                        .description("내가 배심원으로 배정된 소비 심판 목록을 조회합니다.")
