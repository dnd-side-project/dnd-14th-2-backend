...
class LedgerServiceTest extends AbstractIntegrationTest {
    ...
    void 가계부_항목을_생성할_수_있다() {
        // given
        User savedUser = DbUtils.givenSavedUser(userRepository, "kakao-test-1", new Nickname("test"), new InvitationCode("IVCODE"));
    ...
    void 사용자와_가계부ID로_가계부_항목을_조회할_수_있다() {
        // given
        User user = DbUtils.givenSavedUser(userRepository, "kakao-test-1", new Nickname("test"), new InvitationCode("IVCODE"));
    ...
    void 다른_사용자의_가계부를_조회하면_예외를_던진다() {
        // given
        User savedUser1 = DbUtils.givenSavedUser(userRepository, "kakao-test-1", new Nickname("test"), new InvitationCode("IVCODE"));
        LedgerEntry entry = new LedgerEntry(
            5000L,
            LedgerType.EXPENSE,
            LedgerCategory.TRANSPORT,
        ...
        User savedUser2 = DbUtils.givenSavedUser(userRepository, "kakao-test-2", new Nickname("test1"), new InvitationCode("INCODE"));
